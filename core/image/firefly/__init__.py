...
FIREFLY_SIZES = typing.Literal["Portrait", "Landscape", "Square", "Widescreen", "Vertical", "Ultrawide", "Ultrawide Portrait"]
...
class Firefly:
    ...
    @staticmethod
    def generate_settings(prompt: str, width: int = 1024, height: int = 1024, style_prompt: str = "", anchor_prompt: str = "", fix_face: bool = True, seed: int = None) -> dict:
    ...
    async def text_to_image(self, prompt: str, amount: int, *, width: int = 1024, height: int = 1024, styles: list[str] = [], fix_face: bool = True, seed: int = None) -> list[str]:
